...
public class UserReservationListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserReservationListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list != null) {
			...
			request.getRequestDispatcher("views/schoolbus/userResListView.jsp").forward(request, response);
		}else {

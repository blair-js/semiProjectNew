...
/**
 * Servlet implementation class SnackOrderListFormServlet
 */
@WebServlet("/snackOrderListForm.do")
public class SnackOrderListFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SnackOrderListFormServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<SnackOrder> list = new SnackService().selectSnackOrderList(pi); // 간식을 구매한 사용자들 및 간식 내역을 조회해오는 메서드

...
<body>
	...
	<div class="row mt-5">
		...
		<div class="col-md-6 text-center">
			<div class="">
				<img class="col-md-3 mb-2" src="assets/img/gallery/email.png"
					alt="이메일사진" style="max-width: 560px">
			</div>
			<h2>인증 메일이 발송되었습니다.</h2>
			<div class="mt-3">
				<b style="color: #0099FF">jisu@com</b>에서 인증 메일을 확인 바랍니다.<br>
				이메일에서 <b>인증하기</b>를 클릭하시면 인증이 완료됩니다.
			</div>
		</div>
		<div class="col-md-3"></div>
	</div>
	...
	<div class="container mt-4 mb-5" style="max-width: 560px;">
		<div class="alert text-center" style="background-color: #f7f7f9"
			role="alert">
			<h5 style="color: #0099FF">주의사항</h5>
			이메일 인증이 정상적으로 이루어져야<br> 해당 웹사이트의 서비스를 이용하실 수 있습니다.<br>
			<div class="col-md-12 mt-3 text-center">
				<button class="w-100 btn btn-lg mb-2"
					style="background-color: #0099FF;" onclick="goLogin()">

...
<body>
	...
	<main class="form-findId">
		<form style="text-align: center; color: gray;">
			<div class="mb-2">
				<b style="color: #0d6efd">김지수</b>고객님의<br> 비밀번호 찾기가완료되었습니다.<br>
			</div>
			<div class="mb-4">
				비밀번호는<br> <b style="color: #0d6efd">jisu****123</b> 입니다.
			</div>

			<button type="button" class="w-100 btn btn-lg mb-2"
				onclick="goLogin()" style="color: #0099FF; border-color: #0d6efd;">
				<b>로그인 화면으로 돌아가기</b>
			</button>

...
<body>
	...
	<div class="container">
		...
		<div class="px-4 py-5 my-5 text-center">
			...
			<h1 class="display-5 fw-bold" style="color: #808080;">Brand
				Story</h1>

			<br>

			<h3 class="display-5 fw-bold" style="color: #FFCC00">둥글개 둥글개
				유치원은 반려견의 입장에서 생각합니다.</h3>
			<br>
			<div class="col-lg-6 mx-auto">
				<!-- mark 태그로 문구에 대한 강조를 해주었으나 뺴도 상관없음! -->
				<p class="lead mb-4">
					<mark>반려견은 벅찬 사랑과 행복을 주는 동등한 가족입니다.</mark>
					<br> 아이들의 눈높이에 맟춰 사람이 변화하도록 최선의 방법론을 제안합니다.<br> 반려견의 행복하고
					자유로운 삶과 보호자의 편리함을 위한 유치원입니다.
				</p>
		...
		<div class="container-md">
			<div class="row">
				...
				<div class="col-sm row gx-1">
					<img src="assets/img/gallery/intro_dog_1.JPG" width="50"
						height="250px" />
				</div>
				<div class="col-sm row gx-1">
					<img src="assets/img/gallery/intro_dog_2.JPG" width="50"
						height="250px" />
				</div>
				<div class="col-sm row gx-1">
					<img src="assets/img/gallery/intro_dog_3.JPG" width="50"
						height="250px" />
				</div>
				<div class="col-sm row gx-1">
					<img src="assets/img/gallery/intro_dog_4.JPG" width="50"
						height="250px" />
				</div>
			</div>
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h4 class="featurette-heading">
						<h4 style="color: #0099FF">BEAUTY SERVICE</h4>
				...
				<div class="col-md-4 order-md-1">
					<img src="assets/img/gallery/intro_beauty.JPG" width="460"
						height="250px" />
		...
		<div class="container-md">
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h4 class="featurette-heading">
						<h4 style="color: #0099FF">PICKUP SERVICE</h4>
					...
					<p class="lead">
						둥글개 둥글개 유치원에서는 픽업 서비스를 지원하고 있습니다.<br> 아이들을 안전하게 태우고 집에서부터
						유치원까지, 또 유치원에서 집까지 운행하는 픽업 서비스로 견주분들의 편의를 제공하고 있습니다. 물론 언제나 안전
						운전으로 반려견들의 안전은 잊지 않고 <br>운행합니다.
					<P style="color: #FF0000">*강남, 서초 지역 한정, 그중 일부 지역은 제외
					<p></p>
				</div>

				<!-- order-md-2 = 사진 오른쪽 글자 왼쪽 / order-md-1 = 사진 왼쪽 글자 오른쪽 -->
				<div class="col-md-4 order-md-2">
					<img src="assets/img/gallery/intro_pickup.JPG" width="460"
						height="250px" />
		...
		<div class="col-8 mb-7" id="center">
			...
			<img class="w-100" src="assets/img/gallery/intro_location.JPG"

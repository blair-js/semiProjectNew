        ...
        <h1>둥글개 둥글개</h1>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              <li class="nav-item px-2"><a class="nav-link active text-info" aria-current="page" href="index.jsp">홈</a></li>
              <li class="nav-item px-2"><a class="nav-link text-info" aria-current="page" href="<%= contextPath %>/intro.do">소개</a></li>
              <li class="nav-item px-2"><a class="nav-link text-info" aria-current="page" href="<%= contextPath %>/classNoticeList.do">오늘뭐했개</a></li>
              <li class="nav-item px-2"><a class="nav-link text-info" aria-current="page" href="<%=contextPath%>/listQna.do">Q&A</a></li>
              <li class="nav-item px-2"><a class="nav-link text-info" aria-current="page" href="<%=contextPath%>/listNotice.do">공지사항</a></li>
              <li class="nav-item px-2"><a class="nav-link text-info" aria-current="page" href="<%=contextPath%>/snack.do">나만먹을개</a></li>
